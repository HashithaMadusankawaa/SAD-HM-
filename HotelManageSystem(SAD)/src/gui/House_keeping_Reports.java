 ...
 * @author ABC
 */
public class House_keeping_Reports extends javax.swing.JDialog {

    /**
     * Creates new form House_keeping_Reports
     */
    public House_keeping_Reports(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - HOUSE KEEPING LIST");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Emp Name ", "Status", "Room Type", "Assign Status"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String jrxmlPath = "src/reports/HouseBlank_A4_10.jrxml";
            String jasperPath = "src/reports/HouseBlank_A4_10.jasper";
    ...
    private void showReportInDialog(JasperPrint jasperPrint) {
        ...
        JDialog reportDialog = new JDialog(this, "Report Viewer", true); // Modal dialog
        reportDialog.setLayout(new BorderLayout());
        reportDialog.setSize(1000, 800); // Set the size of the dialog

        
        JRViewer viewer = new JRViewer(jasperPrint);
        reportDialog.add(viewer, BorderLayout.CENTER); // Add the JRViewer to the dialog
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(House_keeping_Reports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                House_keeping_Reports dialog = new House_keeping_Reports(new javax.swing.JFrame(), true);
