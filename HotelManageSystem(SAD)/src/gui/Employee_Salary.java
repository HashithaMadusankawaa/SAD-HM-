 ...
 * @author ABC
 */
public class Employee_Salary extends javax.swing.JDialog {

    /**
     * Creates new form Employee_Salary
     */
    public Employee_Salary(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadEmployeeSalary();
    }
   ...
   private void LoadEmployeeSalary() {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Employee Salary Management");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       Employee_Salary_Management employee_Salary_Management= new Employee_Salary_Management(null, true);
       employee_Salary_Management.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Employee_Salary dialog = new Employee_Salary(new javax.swing.JFrame(), true);
