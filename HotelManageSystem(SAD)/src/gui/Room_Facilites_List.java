 ...
 * @author ABC
 */
public class Room_Facilites_List extends javax.swing.JDialog {

    
    public Room_Facilites_List(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        Add_Room_Facilites add_Room_Facilites = new Add_Room_Facilites(null, true);
        add_Room_Facilites.setVisible(true);
        LoadRoomFacilitiesDetails();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Room_Facilites_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Room_Facilites_List dialog = new Room_Facilites_List(new javax.swing.JFrame(), true);
