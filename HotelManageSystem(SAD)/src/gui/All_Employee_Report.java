 ...
 * @author ABC
 */
public class All_Employee_Report extends javax.swing.JDialog {

   
    public All_Employee_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadAllAllEmployeeDetails();
    }

     private void LoadAllAllEmployeeDetails() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - All Employee LIST");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee Id", "First Name", "Last Name", "Join Date", "Email", "Password", "Mobile", "NIC"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/AllEmployeeReportBlank_A4_10.jrxml";
            String jasperPath = "src/reports/AllEmployeeReportBlank_A4_10.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Employee_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                All_Employee_Report dialog = new All_Employee_Report(new javax.swing.JFrame(), true);
