 ...
 * @author ABC
 */
public class Leave_Add extends javax.swing.JDialog {

    private HashMap<String, String> leaveTypeMap = new HashMap<>();
    private HashMap<String, String> EMPMap = new HashMap<>();

    public Leave_Add(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadleavetype();
        loadEmpoylee();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leave_Add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Leave_Add dialog = new Leave_Add(new javax.swing.JFrame(), true);
