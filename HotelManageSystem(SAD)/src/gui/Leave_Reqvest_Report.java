 ...
 * @author ABC
 */
public class Leave_Reqvest_Report extends javax.swing.JDialog {

   
    public Leave_Reqvest_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadLeaveRqvestDetails();
    }

     private void LoadLeaveRqvestDetails() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - Leave Request LIST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/LeaveReqvestBlank_A4_10.jrxml";
            String jasperPath = "src/reports/LeaveReqvestBlank_A4_10.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leave_Reqvest_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Leave_Reqvest_Report dialog = new Leave_Reqvest_Report(new javax.swing.JFrame(), true);
