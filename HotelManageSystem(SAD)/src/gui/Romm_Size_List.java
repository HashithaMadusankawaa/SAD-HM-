 ...
 * @author ABC
 */
public class Romm_Size_List extends javax.swing.JDialog {

   
    public Romm_Size_List(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadRommSizelISTDetails();
    }

     private void LoadRommSizelISTDetails() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - Room Size LIST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/Room_SizeBlank_A4_10.jrxml";
            String jasperPath = "src/reports/Room_SizeBlank_A4_10.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Romm_Size_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Romm_Size_List dialog = new Romm_Size_List(new javax.swing.JFrame(), true);
