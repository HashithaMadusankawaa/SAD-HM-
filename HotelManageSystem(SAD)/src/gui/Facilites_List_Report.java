 ...
 * @author ABC
 */
public class Facilites_List_Report extends javax.swing.JDialog {

   
    public Facilites_List_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - FACILITES LIST");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Facilites Id", "	Facilites Name	Facilites Name"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/fa.jrxml";
            String jasperPath = "src/reports/fa.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Facilites_List_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Facilites_List_Report dialog = new Facilites_List_Report(new javax.swing.JFrame(), true);
