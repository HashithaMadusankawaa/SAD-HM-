 ...
 * @author ABC
 */
public class Bed_List_Report extends javax.swing.JDialog {

   
    public Bed_List_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadBeadDetails();
    }

     private void LoadBeadDetails() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - Bed  LIST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/BedListBlank_A4_10.jrxml";
            String jasperPath = "src/reports/BedListBlank_A4_10.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bed_List_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Bed_List_Report dialog = new Bed_List_Report(new javax.swing.JFrame(), true);
