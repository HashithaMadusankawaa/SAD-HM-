 ...
 * @author ABC
 */
public class Leave_Request extends javax.swing.JDialog {

    /**
     * Creates new form LeaveRequest
     */
    public Leave_Request(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadLeaverequest();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Leave_Add la = new Leave_Add(null, true);
        la.setVisible(true);
        loadLeaverequest();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leave_Request.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Leave_Request dialog = new Leave_Request(new javax.swing.JFrame(), true);
