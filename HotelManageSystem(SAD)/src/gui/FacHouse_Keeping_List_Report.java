 ...
 * @author ABC
 */
public class FacHouse_Keeping_List_Report extends javax.swing.JDialog {

   
    public FacHouse_Keeping_List_Report(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadhOUSEkEEPINGDetails();
    }

     private void LoadhOUSEkEEPINGDetails() {
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL AIR - Housekeeping Checklist");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            String jrxmlPath = "src/reports/HousekeepingChecklistBlank_A4_10.jrxml";
            String jasperPath = "src/reports/HousekeepingChecklistBlank_A4_10.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacHouse_Keeping_List_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FacHouse_Keeping_List_Report dialog = new FacHouse_Keeping_List_Report(new javax.swing.JFrame(), true);
